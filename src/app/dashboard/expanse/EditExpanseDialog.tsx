...
export default function EditExpanseDialog ({ open, onCloseAction, onUpdateAction, label, categories, keywordCategoryId }: EditExpanseDialogProps) {
    const [ selectedCategoryId, setSelectedCategoryId ] = React.useState(keywordCategoryId);
